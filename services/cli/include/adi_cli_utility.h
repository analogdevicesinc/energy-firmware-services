...
/**
 * @file      adi_cli_utility.h
 * @addtogroup ADI_CLI
 * @brief     Utility functions for the CLI service.
 * @details   Contains helper functions for command line interface operations,
 *            including string manipulation, command parsing, and choice handling.
 * @{
 */

#ifndef __ADI_CLI_UTILITY_H__
#define __ADI_CLI_UTILITY_H__
